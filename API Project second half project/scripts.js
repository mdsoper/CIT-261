...
function onClientLoad() {
  gapi.client.load('comicVine', 'v3', comicApiPull);
}
// Attach your key to the API
function comicApiPull() {
  ...
  gapi.client.setApiKey('119760888aaeae0c467c134a22b6667a216debd2');
...
function search(e) {
  ...
  var request = gapi.client.comicvine.search.list({
